    ...
    <form className='flex flex-col sm-flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
           ...
           <div className='flex gap-4'>
            <input className='p-3 border-gray-300 rounded
             w-full' type='file' id='images' accept='image/*' multiple />
             <button className='p-3 text-green-700 border border-greem-700
