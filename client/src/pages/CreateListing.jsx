            ...
            <div className='flex flex-wrap gap-6'>
                ...
                <div className='flex items-center gap-2' >
                    <input type='number' id='discountPrice' min='0'
                     max='1000000' required className='p-3 border border-gray-300 rounded-lg' />
                     <div className='flex flex-col items-center'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
           ...
           <div className='flex gap-4'>
            <input 
             ...
             className='p-3 text-green-700 border border-greem-700
              rounded uppercase hover:shadow-lg disabled:opacity-80'
              >
                 {uploading ? 'Uplading...' : 'Upload'}
               </button>
           </div>
           <p className='text-red-700 text-sms'>
          ...
          </p>
          {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url,index) =>(
                <div key={url} className='flex justify-between p-3
                 border items-center' >
                <img src={url} alt='listing image' className='w-20
                 h-20 object-contain rounded-lg'/>
                 <button type='button'
